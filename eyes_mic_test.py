...
irisMap   = pi3d.Texture("new_graphics/NewDog3.jpg"  , mipmap=False, #change this file to modify the color of the iris
...
while (end - start < total_time):
    ...
    if (OP_MODE == ALERT):
        ...
        pupil_expected_size_right = lux_control(lux_right)
